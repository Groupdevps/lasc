	...
	>
		...
		<template v-slot:item.actions="{item}" v-show="isShowToRoles">
			<v-btn-toggle mandatory>
				<v-btn v-if="item.Triage" small color="primary" @click="redirect({...item, redirectTo: 'DashboardNursing'})"> <v-icon small color="white">mdi-medical-cotton-swab</v-icon></v-btn> 
				<v-btn small color="warning"  @click="redirect({...item, redirectTo: 'TriageClassification'})"> <v-icon small color="white">mdi-alert</v-icon></v-btn> 
			</v-btn-toggle>
