const list =  [{"region":"Región Eje Cafetero - Antioquia","c_digo_dane_del_departamento":"5","departamento":"Antioquia","c_digo_dane_del_municipio":"5.001","municipio":"Medellín"}
...
const departments = list.filter(x => {
	...
	return { name : z.departamento }
})
export default {
	departments,
	cities 		:  list.map(x => {  return {name : x.municipio}})
}