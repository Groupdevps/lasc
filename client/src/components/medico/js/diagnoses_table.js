export default {	
	...
	height  : 200, 
	headers : [				
		{ text : "code", value : "SubDiagnose.code" },
		{ text : "diagnosis", value : "SubDiagnose.name" }, // diagnosis	
		// { text : "", value : "redirect" },
	...
	api_search 			: "/api/v1/find/all/subdiagnose-list/",
