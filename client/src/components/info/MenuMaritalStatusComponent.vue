...
<script>    
    export default{
        name : "MenuMaritalStatusComponent",
        ...
        methods:{
            ...
            async getList(){
                try {
                   if (!this.$store.getters["listMaritalStatus/isList"]) {
                        this.$store.dispatch("listMaritalStatus/getList").then(res=>{
                            this.loading = false;
                        });
                    }else{
                        this.loading= false
                    ...
                    console.warn("error get info marital status ", error)
                }finally{
                    this.loading = false;
                }
            },
            async getSearch(params){
                 try {
                    ...
                    console.warn("error search info marital status ", error)
                }finally{
                    this.loading = false;
                }
            },
            async save(){
                try{
                    ...
                    console.warn("error save info marital status ", error)
                }finally{
                    this.loading = false;
                }
            }
