...
<script>    
    export default{
        ...
        computed:{
            ...
            renderList(){
                return this.$store.getters["listZone/list"];
            },
        ...
        methods:{
            ...
            async getList(){
                try {
                   if (!this.$store.getters["listZone/isList"]) {
                        this.$store.dispatch("listZone/getList").then(res=>{
                            this.loading = false;
                        });
                    }else{
                        this.loading= false
                    ...
                    console.warn("error get info zone ", error)
                }finally{
                    this.loading = false;
                }
            },
            async getSearch(params){
                 try {
                    ...
                    console.warn("error search info zone ", error)
                }finally{
                    this.loading = false;
                }
            },
            async save(){
                try{
                    ...
                    console.warn("error save info zone ", error)
                }finally{
                    this.loading = false;
                }
            }
