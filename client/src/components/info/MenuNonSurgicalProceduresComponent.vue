<template>
    <v-autocomplete
        ...
        :items = "renderList"
        :label = "LabelToMenu || 'PROCEDIMIENTO NO QUIRURGICO'"
        :search-input.sync="searchText"
        item-value = "CupListId"
...
<script>
    import NonSurgicalProceduresService from "@/services/NonSurgicalProceduresService.js"
    export default{
        ...
        methods:{
            async getList(){                
                 try {
                    this.loading = true;
                    const service = new NonSurgicalProceduresService();
            ...
            customFilter (item, queryText, itemText) {
                const textOne = item.description && typeof item.description == 'string' ? item.description.toLowerCase() : ""
