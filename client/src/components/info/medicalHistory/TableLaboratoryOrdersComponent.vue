<template>
	<TableHistoryLayout
		...
		class="elevation-1"				
		:isPdfRow="true"
		:openPdfParentRow="openPdfParentRow"		
	>
...
<script type="text/javascript">	
	...
	import LaboratoryResultService from "@/services/LaboratoryResultService.js"
	...
	export default{
		name : "TableLaboratoryOrdersComponent",
		...
		methods:{
			async getList(){
				try{
					this.loading=true;
					const typeOrder = this.$store.getters["listTypesOrder/getTypeOrderByName"]("ORDEN LABORATORIO");	
