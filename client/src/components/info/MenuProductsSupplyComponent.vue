    ...
    >
        ...
        <template v-slot:item="data">
            ...
            <template v-else>
                ...
                <v-list-item-subtitle v-html="data.item.productTypeName"></v-list-item-subtitle>
...
<script>
    import ProductsSupplyService from "@/services/ProductsSupplyService.js"
    export default{
        name : "MenuProductsSupplyComponent",
        ...
        methods:{
            async getList(){                
                 try {
                    this.loading = true;
                    const service = new ProductsSupplyService();
