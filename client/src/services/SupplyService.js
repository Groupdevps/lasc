...
export default class SupplyService {
    ...
    async findInfo(params){
        try {
            const response = await axios.post(`/api/v1/find/supply/`, params) 
            return response       
        } catch (error) {
            return {error}            
        }
    ...
    async saveInfo(params){
        try {
            const response = await axios.post(`/api/v1/supply`, params) 
            return response       
        } catch (error) {
            return {error}            
        }
    ...
    async updateInfo(params){
        try {
            const response = await axios.put(`/api/v1/supply/${params.id}`, params) 
            return response       
        } catch (error) {
            return {error}            
        }
    ...
    async deleteInfo(params){
        try {
            const response = await axios.delete(`/api/v1/supply/${params.id}`) 
            return response       
        } catch (error) {
            return {error}            
        }
    ...
    async downloadPDF(params){
        try {            
            ...
            const response = await axios.requestAxios({
                url: `/api/v1/supply/${params.id}/pdf`,
                method: 'GET',
            ...
            if(response && response.data){ 
                Helper.downloadFilePdf(response.data, `${params.id}-supply.pdf`);
                return { data : "OK" };
            }
        } catch (error) {
    ...
    linkPdf(params){
        return `/api/v1/supply/${params.id}/pdf`
    }
