...
export default class InventoryService {
    ...
    async saveInfo(params){
        try {
            const response = await axios.post(`/api/v1/inventory`, params) 
            return response       
        } catch (error) {
            return {error}            
        }
    ...
    async updateInfo(params){
        try {
            const response = await axios.put(`/api/v1/inventory/${params.id}`, params) 
            return response       
        } catch (error) {
            return {error}            
        }
    ...
    async deleteInfo(params){
        try {
            const response = await axios.delete(`/api/v1/inventory/${params.id}`) 
            return response       
        } catch (error) {
            return {error}            
        }
