module.exports = [
      ...
      /*  {
        ...
        },//segundo apellido
        {
            ...
            itemValue : "key",
            option : {
                "5": { key : "5", name : "Registro Civil",   x : 83, y: 221 , w: 5, h : 5},
                "21": { key : "2" , name : "Tarjeta de identidad" , x : 83, y: 231 , w: 5, h : 5},
                "1": { key : "1" , name : "Cedula de ciudadania" , x : 83, y: 241 , w: 5, h : 5},
                "3": { key : "3", name : "Cédula de extranjería" , x : 83, y: 250 , w: 5, h : 5},
                "4": { key : "4" , name : "Pasaporte" , x : 183.5, y: 221 , w: 5, h : 5},
                "7": { key : "7" , name : "Adulto sin identificacion" , x : 183.5, y: 231 , w: 5, h : 5},
                "8": { key : "8" , name : "Menor si identificacion" , x : 183.5, y: 240.5 , w: 5, h : 5},
            }
        },//typeId
        {
            key: "patientNumberId",
