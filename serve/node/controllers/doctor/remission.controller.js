  ...
  create: async (req, res) => {
    try {
     /*  // Crear el nuevo discharge
      ...
      res.status(201).json("POST remisión");
    } catch (error) {
 ...
 */      res.status(200).json("GET remisión");
    } catch (error) {
      res.status(400).json({ error: error.message });
    }
  },
  ...
  getById: async (req, res) => {
    try {
      ...
      res.status(200).json("GET ID remisión");
    } catch (error) {
      res.status(400).json({ error: error.message });
    }
  },
  ...
  update: async (req, res) => {
    try {
      ...
      res.status(200).json("UPDATE remisión");
    } catch (error) {
      res.status(400).json({ error: error.message });
    }
  },
  ...
  delete: async (req, res) => {
    try {
      ...
      res.status(204).send(); */
      res.status(200).json("DELETE remisión");
