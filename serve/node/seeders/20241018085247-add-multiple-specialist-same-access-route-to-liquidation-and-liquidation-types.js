...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    const [surgeryLiquidation] = await queryInterface.bulkInsert('SurgeryLiquidations', [
      {
        name: 'MULTIPLE ESPECIALISTA MISMA VIA DE ACCESO',
        active: true,
    ...
    const liquidationTypes = [
      ...
      { SurgeryLiquidationId: surgeryLiquidation.id, name: 'CIRUJANO A', No: 2, ServiceId: serviceId.materiales[0].id, ManualTypeId: manualTypes.soat[0].id, percentage: 0 },
      { SurgeryLiquidationId: surgeryLiquidation.id, name: 'CIRUJANO A', No: 3, ServiceId: serviceId.materiales[0].id, ManualTypeId: manualTypes.soat[0].id, percentage: 0 },
      ...
      { SurgeryLiquidationId: surgeryLiquidation.id, name: 'CIRUJANO B', No: 1, ServiceId: serviceId.derechos[0].id, ManualTypeId: manualTypes.soat[0].id, percentage: 100 },
      ...
      { SurgeryLiquidationId: surgeryLiquidation.id, name: 'CIRUJANO B', No: 1, ServiceId: serviceId.materiales[0].id, ManualTypeId: manualTypes.soat[0].id, percentage: 0 },
      { SurgeryLiquidationId: surgeryLiquidation.id, name: 'CIRUJANO B', No: 2, ServiceId: serviceId.materiales[0].id, ManualTypeId: manualTypes.soat[0].id, percentage: 0 },
      { SurgeryLiquidationId: surgeryLiquidation.id, name: 'CIRUJANO B', No: 3, ServiceId: serviceId.materiales[0].id, ManualTypeId: manualTypes.soat[0].id, percentage: 0 },
